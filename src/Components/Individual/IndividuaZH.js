  ...
  render() {
    ...
    return (
        ...
        //CORPORATE CONNECTIONS
          ...
          <h4> Personnel Connections </h4>{item.value.affiliated_with.map(pers =><div className="itemCard"><div className="itemColumn"><a value="{pers.family_name_en}, {pers.given_name_en}" onClick={(e) => this.setFilter(`${pers.family_name_en}, ${pers.given_name_en}`)}>{pers.family_name_en}, {pers.given_name_en}</a></div><div className="itemColumn">{pers.role}</div><div className="itemColumn">{pers.start_year}-{pers.end_year}</div><div className="itemColumn">{pers.source}</div></div>)}
