    ...
    return (
        ...
        {filteredData.map((item, index) => {
          if (item.value._type === "Person") {
            ...
            <b>替代名稱：</b> {item.value.alt_name_en}<br/>
            <b>國籍：</b> {item.value.nationality}<br/>
            ...
            <div className="genInf">
            <div className="itemColumn50">
            <b>替代名稱：</b> {item.value.alt_inst_name_en}<br/>
            <b>類型：</b> {item.value.inst_type}<br/>
            <b>開始年份：</b> {item.value.start_year}</div>
            <div className="itemColumn50">
            <b>中文名：</b> {item.value.inst_name_zh}<br/>
            <b>宗教家庭：</b> {item.value.religious_family}<br/>
            <b>結束年份：</b> {item.value.end_year}</div></div></div>
          }
          else if (item.value._type === "CorporateEntity") {
            return <div className="sixty">
            <div className="genInf">
            <div className="itemColumn50">
            <b>替代名稱：</b> {item.value.alt_corp_name_en}<br/>
            <b>類型：</b> {item.value.corp_type}<br/>
            <b>開始年份：</b> {item.value.start_year}</div>
            <div className="itemColumn50">
            ...
            <div className="genInf">
            <div className="itemColumn50">
            <b>替代名稱：</b> {item.value.alt_event_name_en}<br/>
            <b>地點：</b> {item.value.location}<br/>
            <b>開始年份：</b> {item.value.start_year}</div>
            <div className="itemColumn50">
        ...
        {filteredData.map((item, index) => {
          ...
          if (item.value._type === "Person") {
            //REL,PRES,AFF,PART
            if (item.value.related_to && item.value.present_at && item.value.affiliated_with && item.value.participant_at) {return <div><h4> 個人關係 </h4>{item.value.related_to.map(pers => <div className="itemCard"><div className="itemColumn"> <a value="{pers.family_name_en}, {pers.given_name_en}" onClick={(e) => this.setFilter(`${pers.family_name_en}, ${pers.given_name_en}`)}>{pers.family_name_en}, {pers.given_name_en}</a></div><div className="itemColumn">{pers.rel_type}</div><div className="itemColumn">{pers.start_year}-{pers.end_year}</div><div className="itemColumn">{pers.source}</div></div>)}<h4> 機構聯繫 </h4>{item.value.present_at.map(present => <div className="itemCard"><div className="itemColumn"><a value="present.inst_name_en" onClick={(e) => this.setFilter(present.inst_name_en)}>{present.inst_name_en}</a></div><div className="itemColumn">{present.role}</div><div className="itemColumn">{present.start_year}-{present.end_year}</div><div className="itemColumn">{present.source}</div></div>)}<h4> 公司關係 </h4>{item.value.affiliated_with.map(aff => <div className="itemCard"><div className="itemColumn"><a value="aff.corp_name_en" onClick={(e) => this.setFilter(aff.corp_name_en)}>{aff.corp_name_en}</a></div><div className="itemColumn">{aff.rel_type}</div><div className="itemColumn">{aff.start_year}-{aff.end_year}</div><div className="itemColumn">{aff.source}</div></div>)}<h4> 事件連接 </h4>{item.value.participant_at.map(eve => <div className="itemCard"><div className="itemColumn"><a value="eve.event_name_en" onClick={(e) => this.setFilter(eve.event_name_en)}>{eve.event_name_en}</a></div><div className="itemColumn">{eve.role}</div><div className="itemColumn">{eve.start_year}-{eve.end_year}</div><div className="itemColumn">{eve.source}</div></div>)}</div>}
            //PRES, REL, AFF
            else if (item.value.related_to && item.value.present_at && item.value.affiliated_with) {return <div><h4> 個人關係 </h4>{item.value.related_to.map(pers => <div className="itemCard"><div className="itemColumn"> <a value="{pers.family_name_en}, {pers.given_name_en}" onClick={(e) => this.setFilter(`${pers.family_name_en}, ${pers.given_name_en}`)}>{pers.family_name_en}, {pers.given_name_en}</a></div><div className="itemColumn">{pers.rel_type}</div><div className="itemColumn">{pers.start_year}-{pers.end_year}</div><div className="itemColumn">{pers.source}</div></div>)}<h4> 機構聯繫 </h4>{item.value.present_at.map(present => <div className="itemCard"><div className="itemColumn"><a value="present.inst_name_en" onClick={(e) => this.setFilter(present.inst_name_en)}>{present.inst_name_en}</a></div><div className="itemColumn">{present.role}</div><div className="itemColumn">{present.start_year}-{present.end_year}</div><div className="itemColumn">{present.source}</div></div>)}<h4> 公司關係 </h4>{item.value.affiliated_with.map(aff => <div className="itemCard"><div className="itemColumn"><a value="aff.corp_name_en" onClick={(e) => this.setFilter(aff.corp_name_en)}>{aff.corp_name_en}</a></div><div className="itemColumn">{aff.rel_type}</div><div className="itemColumn">{aff.start_year}-{aff.end_year}</div><div className="itemColumn">{aff.source}</div></div>)}</div>}
            //PRES, REL, PART
            ...
            //REL, AFF, PART
            else if (item.value.related_to && item.value.affiliated_with && item.value.participant_at) {return <div><h4> 個人關係 </h4>{item.value.related_to.map(pers =><div className="itemCard"><div className="itemColumn"> <a value="{pers.family_name_en}, {pers.given_name_en}" onClick={(e) => this.setFilter(`${pers.family_name_en}, ${pers.given_name_en}`)}>{pers.family_name_en}, {pers.given_name_en}</a></div><div className="itemColumn">{pers.rel_type}</div><div className="itemColumn">{pers.start_year}-{pers.end_year}</div><div className="itemColumn">{pers.source}</div></div>)}<h4> 機構聯繫 </h4>{item.value.present_at.map(present =><div className="itemCard"><div className="itemColumn"><a value="present.inst_name_en" onClick={(e) => this.setFilter(present.inst_name_en)}>{present.inst_name_en}</a></div><div className="itemColumn">{present.role}</div><div className="itemColumn">{present.start_year}-{present.end_year}</div><div className="itemColumn">{present.source}</div></div>)}<h4> 公司關係 </h4>{item.value.affiliated_with.map(aff =><div className="itemCard"><div className="itemColumn"><a value="aff.corp_name_en" onClick={(e) => this.setFilter(aff.corp_name_en)}>{aff.corp_name_en}</a></div><div className="itemColumn">{aff.rel_type}</div><div className="itemColumn">{aff.start_year}-{aff.end_year}</div><div className="itemColumn">{aff.source}</div></div>)}<h4> 事件連接 </h4>{item.value.participant_att.map(eve =><div className="itemCard"><div className="itemColumn"><a value="eve.event_name_en" onClick={(e) => this.setFilter(eve.event_name_en)}>{eve.event_name_en}</a></div><div className="itemColumn">{eve.role}</div><div className="itemColumn">{eve.start_year}-{eve.end_year}</div><div className="itemColumn">{eve.source}</div></div>)}</div>}
            //REL, PRES
            else if (item.value.related_to && item.value.present_at) {return <div><h4> 個人關係 </h4>{item.value.related_to.map(pers =><div className="itemCard"><div className="itemColumn"> <a value="{pers.family_name_en}, {pers.given_name_en}" onClick={(e) => this.setFilter(`${pers.family_name_en}, ${pers.given_name_en}`)}>{pers.family_name_en}, {pers.given_name_en}</a></div><div className="itemColumn">{pers.rel_type}</div><div className="itemColumn">{pers.start_year}-{pers.end_year}</div><div className="itemColumn">{pers.source}</div></div>)}<h4> 機構聯繫 </h4>{item.value.present_at.map(present =><div className="itemCard"><div className="itemColumn"><a value="present.inst_name_en" onClick={(e) => this.setFilter(present.inst_name_en)}>{present.inst_name_en}</a></div><div className="itemColumn">{present.role}</div><div className="itemColumn">{present.start_year}-{present.end_year}</div><div className="itemColumn">{present.source}</div></div>)}</div>}
            //REL, AFF
        ...
        //公司關係
          ...
          <h4> 人員連接 </h4>{item.value.affiliated_with.map(pers =><div className="itemCard"><div className="itemColumn"><a value="{pers.family_name_en}, {pers.given_name_en}" onClick={(e) => this.setFilter(`${pers.family_name_en}, ${pers.given_name_en}`)}>{pers.family_name_en}, {pers.given_name_en}</a></div><div className="itemColumn">{pers.rel_type}</div><div className="itemColumn">{pers.start_year}-{pers.end_year}</div><div className="itemColumn">{pers.source}</div></div>)}
          <h4> 機構聯繫 </h4>{item.value.part_of.map(part =><div className="itemCard"><div className="itemColumn"><a value="part.inst_name_en" onClick={(e) => this.setFilter(part.inst_name_en)}>{part.inst_name_en}</a></div><div className="itemColumn">{part.rel_type}</div><div className="itemColumn">{part.start_year}-{part.end_year}</div><div className="itemColumn">{part.source}</div></div>)}</div>}
          //OF
          else if (item.value.part_of) {return <div><h4> 機構聯繫 </h4>{item.value.part_of.map(part =><div className="itemCard"><div className="itemColumn"><a value="part.inst_name_en" onClick={(e) => this.setFilter(part.inst_name_en)}>{part.inst_name_en}</a></div><div className="itemColumn">{part.rel_type}</div><div className="itemColumn">{part.start_year}-{part.end_year}</div><div className="itemColumn">{part.source}</div></div>)}</div>}
          //AFF
          else if (item.value.affiliated_with) {return <div><h4> 人員連接 </h4>{item.value.affiliated_with.map(pers =><div className="itemCard"><div className="itemColumn"><a value="{pers.family_name_en}, {pers.given_name_en}" onClick={(e) => this.setFilter(`${pers.family_name_en}, ${pers.given_name_en}`)}>{pers.family_name_en}, {pers.given_name_en}</a></div><div className="itemColumn">{pers.rel_type}</div><div className="itemColumn">{pers.start_year}-{pers.end_year}</div><div className="itemColumn">{pers.source}</div></div>)}</div>}
        }
          //事件連接
          else if (item.value._type === "Event") {
          //PART
